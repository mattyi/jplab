...
public class IntervalDoubleParameterTest {
  ...
  public void testSetValue() {
    IntervalDoubleParameter parameter = new IntervalDoubleParameter(0.0, "parameter", 0.0, 5.0, 10);
  ...
  public void testSetValueException() {
    IntervalDoubleParameter parameter = new IntervalDoubleParameter(0.0, "parameter", 0.0, 5.0, 5);
