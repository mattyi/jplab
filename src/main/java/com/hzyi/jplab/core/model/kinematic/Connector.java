...
public abstract class Connector implements KinematicModel {
   ...
   */
  protected static interface modelBuilder<B> {
   ...
   * function. The builder class must implement modelBuilder too.
   */
  protected static <B extends modelBuilder<B>> BiFunction<B, String, B> connectedModelExtractor(
